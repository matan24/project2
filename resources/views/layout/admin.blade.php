...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><span>Rental</span>Mobil</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>List Data</span> <i class="bi bi-chevron-right"></i></a>
            <ul>
              <li><a href="{{ route('admin.datarental') }}">Data Daftar Rental</a></li>
            </ul>
          </li>
        </ul>
        <li class="dropdown"><a href="#"><span>Input Data</span> <i class="bi bi-chevron-right"></i></a>
          <ul>
            <li><a href="{{ route('admin.inputrental') }}">Input Waktu Rental</a></li>
            {{-- <li><a href="{{ route('admin.informasi.inputinfo') }}">Input Paket Rental</a></li></li> --}}
            <li><a href="{{ route('admin.mobil.inputmobil') }}">Input Mobil Rental</a></li></li>
            <li>
