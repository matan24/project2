...
@section('title', 'Edit Waktu Rental Admin | Rental Mobil')
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="{{ route('admin.showinput') }}">Detail data</a></li>
          </ol>
        </div>
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <div class="section-title">
                <h2>Update Data waktu rental</h2>
              </div>

              <a href="{{ route('admin.showinput') }}">Kembali</a>
              <form  method="post" action="{{ route('admin.editrental.update', $input->id ) }}">
                @method('patch')
                @csrf
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" id="nama" value="{{ $input->nama }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="waktu" id="waktu" value="{{ $input->waktu }}">
                  </div>
                </div>
