...
@section('title', 'Data Rental Admin | Rental Mobil')
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <table class="table table-striped table-dark table-bordered">
                <a href="{{ route('admin.detaillaporan') }}" class="btn btn-info">Detail Data</a>
                <br><br>
                <thead>
                ...
                <tbody>
                  ...
                  $waktu_selesai = date('Y-m-d', strtotime("+$item->lama_proses days", strtotime($tanggal)));
                  $ta = date_diff(date_create($waktu_selesai),date_create($tanggal))->d;
                  @endphp    
                  <tr>                             
