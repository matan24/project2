...
@section('title', 'Detail Laporan Rental Admin | Rental Mobil')
      ...
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            ...
            <li><a href="{{ route('admin.inputrental') }}">Input Waktu Rental</a></li>
            <li><a href="{{ route('admin.showinput') }}">Detail Data Waktu Rental</a></li> --}}
          </ol>
        </div>
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <table class="table table-striped table-dark table-bordered">
                <a href="{{ route('admin.datarental') }}" class="btn btn-info">Kembali</a>
                <br><br>
                ...
                <tbody>
                  ...
                  <th scope="row">{{ $loop->iteration }}</th>
                    ...
                    <td class="">
                      <a href="{{ route('admin.editlaporan', $item->id ) }}" class="btn btn-warning mb-2"><i class="fa-solid fa-pen-to-square"></i></a>
    
                      <form action="{{ route('admin.detaillaporan.delete', $item->id)}}" method="post">
                          @method('delete')
                          @csrf 
