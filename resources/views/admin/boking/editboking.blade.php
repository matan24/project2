...
@section('title', 'Update Laporan Penyewa Admin | Rental Mobil')
      ...
      <div class="container">
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <a href="{{ route('admin.boking.detailboking') }}" class="btn btn-warning">Kembali</a>
    
              <form method="post" action="{{ route('admin.boking.editboking.update', $boking->id ) }}">
                @method('patch')
                @csrf
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama" id="nama" value="{{ $boking->nama }}">
                    </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="no" id="no" value="{{ $boking->no }}">
                      </div>
                  </div>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="mobil" id="mobil" value="{{ $boking->mobil }}">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="plat" id="plat" value="{{ $boking->plat }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="tanggal" id="tanggal" value="{{ $boking->tanggal }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="waktu" id="waktu" value="{{ $boking->waktu }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="harga" id="harga" value="{{ $boking->harga }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="denda" id="denda" value="{{ $boking->denda }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                      <select id="pembayaran" name="pembayaran" class="form-control custom-select">
                        ...
                        <option {{ $boking->pembayaran == "Lunas" ? "selected" : "" }}>
                          Lunas
                          </option>
                        <option {{ $boking->pembayaran == "Deposit (Dp)" ? "selected" : "" }}>
                          Deposit (Dp)
                        </option>
                        <option {{ $boking->pembayaran == "Belum Lunas" ? "selected" : "" }}>
                          Belum Lunas
                        </option>
                        <option {{ $boking->pembayaran == "Denda" ? "selected" : "" }}>
                          Denda
                        </option>
                      </select>
                  </div>
