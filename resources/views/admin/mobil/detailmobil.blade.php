...
@section('title', 'Detail Mobil | Rental Mobil')
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <table class="table table-bordered table-dark">
                ...
                <a href="{{ route('admin.mobil.inputmobil') }}" class="btn btn-warning mb-4">Kembali</a>
                <thead>
                ...
                <tbody>
                  ...
                  <th scope="row">{{ $loop->iteration }}</th>
                    ...
                    <td>{{ $item->status }}</td>
                    <td class="">
                        <a href="{{ route('admin.mobil.editmobil', $item->id )}}" class="btn btn-warning mb-2"><i class="fa-solid fa-pen-to-square"></i></a>
      
                        <form action="{{ route('admin.mobil.detailmobil.delete', $item->id )}}" method="post">
                            @method('delete')
                            @csrf 
