...
@section('title', 'Update Mobil Rental Admin | Rental Mobil')
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <ol>
            <li><a href="{{ route('admin.mobil.detailmobil') }}">Update data mobil</a></li>
          </ol>
        </div>
        ...
        <section id="features" class="features">
            <div class="container" data-aos="fade-up">
              ...
              <form action="{{ route('admin.mobil.editmobil.update', $mobil->id) }}" method="post">
                @method('patch')
                @csrf
                <br>
                @if (session('status'))
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="plat" id="plat" value="{{ $mobil->plat }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="tarif" id="tarif" value="{{ $mobil->tarif }}">
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                      <select id="status" name="status" class="form-control custom-select">
                        ...
                        <option {{ $mobil->status == "Mobil Ready" ? "selected" : "" }}>
                          Mobil Ready
                        </option>
                        <option {{ $mobil->status == "Mobil diboking" ? "selected" : "" }}>
                          Mobil Diboking
                        </option>
                      </select>
                  </div>
